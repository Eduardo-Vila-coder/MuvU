    ...
    public void sendEmailWithThymeLeaf(Mail mail) {
        ...
        for (String destinatario : mail.getTo()) {
            try {
                ...
                // Un correo fallido no debe afectar a la operación (ya confirmada) ni a los demás destinatarios
                log.error("No se pudo enviar el correo '{}' a {}", mail.getSubject(), destinatario, e);
            }
        }
    }
}
